package com.copart.solrbatchmonitor.us.colomariadb.entities;
...
@Entity
@Table(name = "batch_search",schema="misprddb")
public class UsColoMariadb {
	@Id
	...
	public UsColoMariadb(){}
	
	public UsColoMariadb(int batch_id, Timestamp start_dttm, Timestamp end_dttm, Timestamp update_dttm, String object_count, String batch_status, String object_type, String param){
