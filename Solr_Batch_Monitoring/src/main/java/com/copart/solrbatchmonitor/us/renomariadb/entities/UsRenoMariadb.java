package com.copart.solrbatchmonitor.us.renomariadb.entities;
...
public class UsRenoMariadb {
	...
	public UsRenoMariadb(){}
	
	public UsRenoMariadb(int batch_id, Timestamp start_dttm, Timestamp end_dttm, Timestamp update_dttm, String object_count, String batch_status, String object_type, String param){
