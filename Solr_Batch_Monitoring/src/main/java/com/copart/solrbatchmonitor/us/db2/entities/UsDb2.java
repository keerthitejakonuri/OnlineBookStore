package com.copart.solrbatchmonitor.us.db2.entities;
...
public class UsDb2 {
	...
	public UsDb2(int batch_id, Timestamp start_dttm, Timestamp end_dttm, Timestamp update_dttm, String object_count, String batch_status, String object_type, String param){
