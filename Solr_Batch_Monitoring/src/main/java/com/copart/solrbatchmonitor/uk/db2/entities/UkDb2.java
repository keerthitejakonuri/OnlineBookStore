package com.copart.solrbatchmonitor.uk.db2.entities;
...
public class UkDb2 {
	...
	public UkDb2(int batch_id, Timestamp start_dttm, Timestamp end_dttm, Timestamp update_dttm, String object_count, String batch_status, String object_type, String param){
