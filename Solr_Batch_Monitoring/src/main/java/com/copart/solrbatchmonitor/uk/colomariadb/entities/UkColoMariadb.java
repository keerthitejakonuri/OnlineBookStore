package com.copart.solrbatchmonitor.uk.colomariadb.entities;
...
public class UkColoMariadb {
	...
	public UkColoMariadb(){}
	
	public UkColoMariadb(int batch_id, Timestamp start_dttm, Timestamp end_dttm, Timestamp update_dttm, String object_count, String batch_status, String object_type, String param){
